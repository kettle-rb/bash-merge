...
✅ **CORRECT**:
```bash
mise exec -C /home/pboling/src/kettle-rb/ast-merge/vendor/bash-merge -- bundle exec rspec
```

✅ **CORRECT**:
```bash
eval "$(mise env -C /home/pboling/src/kettle-rb/ast-merge/vendor/bash-merge -s bash)" && bundle exec rspec
```
...
mise exec -C /home/pboling/src/kettle-rb/ast-merge/vendor/bash-merge -- env K_SOUP_COV_MIN_HARD=false bundle exec rspec spec/bash/merge/smart_merger_spec.rb

# Specific backend tests
mise exec -C /home/pboling/src/kettle-rb/ast-merge/vendor/bash-merge -- bundle exec rspec --tag mri_backend
mise exec -C /home/pboling/src/kettle-rb/ast-merge/vendor/bash-merge -- bundle exec rspec --tag rust_backend
mise exec -C /home/pboling/src/kettle-rb/ast-merge/vendor/bash-merge -- bundle exec rspec --tag bash_grammar
```

### Coverage Reports

```bash
mise exec -C /home/pboling/src/kettle-rb/ast-merge/vendor/bash-merge -- bin/rake coverage
mise exec -C /home/pboling/src/kettle-rb/ast-merge/vendor/bash-merge -- bin/kettle-soup-cover -d
```
